  ...
  return (
    <div className="min-h-screen bg-farm-bg pb-8">
      ...
      <header className="bg-white px-4 pt-safe pt-4 pb-4 flex items-center gap-3 border-b border-gray-100 sticky top-0 z-30">
        ...
        {/* Phase 8: 상태 배지 */}
        {job.status === 'closed'  && <span className="ml-auto text-xs bg-red-50 text-red-600 font-bold px-2 py-1 rounded-full">마감</span>}
        {job.status === 'matched' && <span className="ml-auto text-xs bg-blue-50 text-blue-600 font-bold px-2 py-1 rounded-full">연결완료</span>}
      </header>
