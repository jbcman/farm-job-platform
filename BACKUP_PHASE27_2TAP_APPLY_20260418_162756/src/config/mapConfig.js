...
// STEP 4 디버그 로그: 키 로딩 상태 확인
const keyStatus = VWORLD_KEY === '40875C91-3F61-31B1-869E-6AFE1364138B' ? 'hardcoded-fallback' : 'env-loaded';
console.log('[VWORLD_KEY]', VWORLD_KEY, '|', keyStatus);
