...
import { getJobs, getMyJobs, getMyApplications, applyJob, startJob, completeJob, closeJob } from '../utils/api.js';
...
export default function JobListPage({ userId, myJobsMode, myApplicationsMode, onBack, onViewApplicants, onViewJobDetail, onCopyJob }) {
  ...
  const displayJobs  = isPublicList
    ? sortJobsByRecommend(filterUrgentOnly(jobs, urgentOnly), userProfile)
    : jobs;
